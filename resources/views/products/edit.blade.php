                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('products.update', $product->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700" name="name" value="{{ old('name', $product->name) }}">
                            @error('name') <span class="text-red-500 text-sm mt-1">{{ $message }}</span> @enderror
                        </div>
                        <div class="mt-4">
                            <label for="code" class="block font-medium text-sm text-gray-700 dark:text-gray-300">Kode Produk</label>
                            <input type="text" id="code" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700" name="code" value="{{ old('code', $product->code) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <input type="number" id="price" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700" name="price" value="{{ old('price', $product->price) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <input type="number" id="stock" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700" name="stock" value="{{ old('stock', $product->stock) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="description" name="description" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700">{{ old('description', $product->description) }}</textarea>
                        </div>
